<?php
	...
	if( $_SERVER["REQUEST_METHOD"] == "POST"){
		...
		if( isset($_POST['update']) ){
			...
			header("location: cityManagerUpdate.php");
		}

		else if( isset($_POST['delete']) ){

			$user_id = $_POST['user_id'];
			$sql = "CALL sp_delete_city_manager('$user_id')";
			...
			$username = mysqli_real_escape_string($conn, $_POST['username']);
	      	...
	      	$sql = "CALL sp_insert_city_manager('$username', '$password', '$mail_address', '$first_name', '$last_name', '$authorisation_type', '$city_name')";
	...
	$sql = "SELECT * FROM user natural join city_manager natural join city";
	$cityManagers = mysqli_query($conn, $sql);
	...
	if( !$cityManagers || !$cities || !$authorisationTypes )
		header("location: 404.php");
		...
		<!-- Page container -->
	 	<div class="page-container">
			...
			<div class="sidebar">
				<div class="sidebar-content">
					...
					<ul class="navigation">
						...
						<li class="active"><a href="cityManager.php"><span>CRUD City Manager</span> <i class="icon-users"></i></a></li>
			...
			<!-- Page content -->
	 		...
	 		burada şehir yöneticisi CRUD işlmeleri yapılacak

	 			<form action="cityManager.php" method="post" role="form" class="form-horizontal">
			        <div class="panel panel-default">
			            <div class="panel-heading"><h6 class="panel-title"><i class="icon-paragraph-right2"></i>Add City Manager</h6></div>
			            <div class="panel-body">
					        ...
					        <div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="col-sm-12">
			                                <select name="selected_city_name" id="selected_authorisation_type" class="form-control input-lg">			                                   	
	            ...
	            <div class="panel panel-default">
	                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i>City Managers List</h6></div>
	                <div class="datatable">
		                ...
		                <table class="table">
		                    ...
		                    <tbody>
		                    	...
		                    	<?php while($cityManager = $cityManagers->fetch_assoc()){ ?>
			                        <tr>
			                        	<form action="cityManager.php" method="post">
				                        	<td><?php echo $cityManager["username"]; ?></td>
				                        	<td><?php echo $cityManager["password"]; ?></td>
				                        	<td><?php echo $cityManager["mail_address"]; ?></td>
				                        	<td><?php echo $cityManager["first_name"]; ?></td>
				                        	<td><?php echo $cityManager["last_name"]; ?></td>
				                        	<td><?php echo $cityManager["name"]; ?></td>
				                        	<td>
				                        		<input type="text" name="user_id" value=<?php echo $cityManager["user_id"]; ?> hidden />
