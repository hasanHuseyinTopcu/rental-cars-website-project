<?php
	...
	if(isset($_SESSION['user_id'])){
	    ...
	    $sql = "SELECT * FROM user natural join city_manager natural join city natural join authorisation WHERE user_id = '$user_id'";
	    $cityManager = $conn->query($sql);
	...
	if( $_SERVER["REQUEST_METHOD"] == "POST" AND isset($_POST['update'])){
		...
		$username = mysqli_real_escape_string($conn, $_POST['username']);
      	...
      	$sql = "CALL sp_update_city_manager('$user_id', '$username', '$new_password', '$mail_address', '$first_name', '$last_name', '$city_name')";
...
<title>update city manager PAge</title>
	 	...
	 	<div class="page-container">
			...
			<!-- Page content -->
	 		<div class="page-content">
	 			...
	 			<form action="cityManagerUpdate.php" method="post" role="form" class="form-horizontal">
			        <div class="panel panel-default">
			            <div class="panel-heading"><h6 class="panel-title"><i class="icon-paragraph-right2"></i>Update City Manager</h6></div>
			            <div class="panel-body">
					        ...
					        <div class="form-group">
					            ...
					            <div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" name="username" class="form-control" value=<?php echo $cityManager["username"]; ?> required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" name="mail_address" class="form-control" value=<?php echo $cityManager["mail_address"]; ?> required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" name="first_name" class="form-control" value=<?php echo $cityManager["first_name"]; ?> required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" name="last_name" class="form-control" value=<?php echo $cityManager["last_name"]; ?> required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" name="city_name" class="form-control" value=<?php echo $cityManager["name"]; ?> required>
									</div>
								</div>
