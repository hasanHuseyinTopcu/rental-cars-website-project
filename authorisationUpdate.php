<?php
	...
	if(isset($_SESSION['authorisation_id'])){
	    $authorisation_id = (int)$_SESSION['authorisation_id'];

	    $sql = "SELECT * FROM authorisation WHERE authorisation_id = '$authorisation_id'";
	    $authorisation = $conn->query($sql);
	    $authorisation = $authorisation->fetch_assoc();
	...
	if( $_SERVER["REQUEST_METHOD"] == "POST" AND isset($_POST['update'])){
		...
		$authorisation_id = (int)$_SESSION['authorisation_id'];
      	...
      	$sql = "CALL sp_update_authorisation_by_authorisation_id('$authorisation_id', '$authorisation_type')";

      	if ($conn->query($sql) === TRUE) {

      		unset($_SESSION['authorisation_id']);
...
<title>Authorisation Update Page</title>
	 	...
	 	<div class="page-container">
			...
			<!-- Page content -->
	 		<div class="page-content">
	 			...
	 			<h4>update authorisation page</h4>

	 			<form action="" method="post" role="form" class="form-horizontal">
			        <div class="panel panel-default">
			            <div class="panel-heading"><h6 class="panel-title"><i class="icon-paragraph-right2"></i>update Authorisation</h6></div>
			            <div class="panel-body">
					        ...
					        <div class="form-group">
					            ...
					            <div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" name="authorisation_type" class="form-control" value=<?php echo $authorisation['authorisation_type']; ?> required>
									</div>
								</div>
